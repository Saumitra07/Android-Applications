        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try
                {
                    ...
                    if(email.isEmpty()){
                        Toast.makeText(getActivity().getBaseContext(), "Enter  email !!", Toast.LENGTH_SHORT).show();
                    } else if(password.isEmpty()){
                        Toast.makeText(getActivity().getBaseContext(), "Enter valid password !!", Toast.LENGTH_SHORT).show();
                    }
                    else
                    if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                        Toast.makeText(getActivity().getBaseContext(), "Enter valid Email address !", Toast.LENGTH_SHORT).show();
                        return;
